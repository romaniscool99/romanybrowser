            ...
            overrideDocumentURI() {
                this.ctx.overrideDescriptor(this.docProto, "documentURI", {
                    get: (t, r) => {
                        ...
                        return this.emit("documentURI", i),
                        i.intercepted ? i.returnValue : i.data.value
                    }
                })
            }
            ...
            overrideHtml() {
                this.hookProperty(this.Element, "innerHTML", {
                    get: (t, r) => {
                        ...
                        return this.emit("getInnerHTML", i),
                        i.intercepted ? i.returnValue : i.data.value
                    }
                    ,
                    set: (t, r, [i]) => {
                ...
                this.hookProperty(this.Element, "outerHTML", {
                    get: (t, r) => {
                        ...
                        return this.emit("getOuterHTML", i),
                        i.intercepted ? i.returnValue : i.data.value
                    }
                    ,
                    set: (t, r, [i]) => {
            ...
            overrideTextContent() {
                this.ctx.overrideDescriptor(this.nodeProto, "textContent", {
                    get: (t, r) => {
                        ...
                        return this.emit("getTextContent", i),
                        i.intercepted ? i.returnValue : i.data.value
                    }
                    ,
                    set: (t, r, [i]) => {
            ...
            overrideParent() {
                ...
                this.ctx.overrideDescriptor(this.nodeProto, "parentElement", {
                    get: (t, r) => {
                        ...
                        return this.emit("parentElement", i),
                        i.intercepted ? i.returnValue : i.data.node
                    }
                })
            }
            overrideOwnerDocument() {
                this.ctx.overrideDescriptor(this.nodeProto, "ownerDocument", {
                    get: (t, r) => {
                        ...
                        return this.emit("ownerDocument", i),
            ...
            overrideUrl() {
                ...
                this.ctx.overrideDescriptor(this.resProto, "url", {
                    get: (t, r) => {
                        ...
                        return this.emit("responseUrl", i),
                        i.intercepted ? i.returnValue : i.data.value
                    }
                }),
                !0
            ...
            overrideHeaders() {
                return !!this.Headers && (this.ctx.overrideDescriptor(this.reqProto, "headers", {
                    get: (t, r) => {
                        ...
                        return this.emit("requestHeaders", i),
                        i.intercepted ? i.returnValue : i.data.value
                    }
                }),
                this.ctx.overrideDescriptor(this.resProto, "headers", {
                    get: (t, r) => {
                        ...
                        return this.emit("responseHeaders", i),
                        i.intercepted ? i.returnValue : i.data.value
                    }
                }),
        ...
        const c = class extends t {
            ...
            overrideGetResHeaders() {
                this.ctx.override(this.xhrProto, "getAllResponseHeaders", ( (t, r) => {
                    ...
                    return this.emit("getAllResponseHeaders", i),
                    i.intercepted ? i.returnValue : i.data.value
                }
                ))
            }
        ...
        const w = class extends t {
            ...
            wrapPostMessage(t, r, i=!1) {
                return this.ctx.wrap(t, r, ( (r, o, s) => {
                    ...
                    l.intercepted ? l.returnValue : i ? l.target.call(l.that, l.data.message, l.data.transfer) : l.target.call(l.that, l.data.message, l.data.origin, l.data.transfer)
                }
                ))
            }
            ...
            overrideName() {
                this.ctx.overrideDescriptor(this.idbDatabaseProto, "name", {
                    get: (t, r) => {
                        ...
                        return this.emit("idbFactoryName", i),
                        i.intercepted ? i.returnValue : i.data.value
                    }
                })
            }
